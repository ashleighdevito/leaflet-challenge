...
function createFeatures(earthquakeData) {
    ...
    // Give each feature a popup that describes the place and time of the earthquake.
      ...
      function onEachFeature(feature, marker) {
        ...
        marker.bindPopup(`<h3>Magnitude: ${quakemag}<span style="margin-left:40px">Depth: ${quakedepth}km</span></h3><hr><h4>Location: ${feature.properties.place}</h4><hr><p>Time: ${new Date(feature.properties.time)}</p>`);
      }
